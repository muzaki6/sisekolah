        ...
        <div class="row">
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('mapels.update', ['mapel' => $mapel->id_mapel]) }}" method="post"
                            enctype="multipart/form-data">
                            @csrf
                            <div class="form-group row mb-1">
                                <label for="id_mapel" class="col-sm-2 col-form-label">ID Mapel</label>
                                <div class="col-sm-10">
                                    <input value="{{ $mapel->id_mapel }}" id="id_mapel" name="id_mapel" type="text"
                            ...
                            <div class="form-group row mb-1">
                                ...
                                <div class="col-sm-10">
                                    <input value="{{ $mapel->mapel }}" id="mapel" name="mapel" type="text"
                                        class="form-control" placeholder="Masukan Mata Pelajaran">
                                </div>
                            </div>
